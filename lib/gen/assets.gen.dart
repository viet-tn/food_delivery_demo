...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/congrats.png
  AssetGenImage get congrats =>
      const AssetGenImage('assets/icons/congrats.png');
  ...
  /// File path: assets/icons/location_pin_outlined.png
  AssetGenImage get locationPinOutlined =>
      const AssetGenImage('assets/icons/location_pin_outlined.png');
  ...
  /// File path: assets/icons/profile_nav.png
  ...
  /// File path: assets/icons/star_full.png
  AssetGenImage get starFull =>
      const AssetGenImage('assets/icons/star_full.png');

  /// File path: assets/icons/voucher_icon.png
  AssetGenImage get voucherIcon =>
      const AssetGenImage('assets/icons/voucher_icon.png');
...
class $AssetsImagesSplashGen {
  ...
  /// File path: assets/images/splash/bg_pattern.png
  AssetGenImage get bgPattern =>
      const AssetGenImage('assets/images/splash/bg_pattern.png');
